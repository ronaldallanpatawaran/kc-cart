...
class ControllerStep3 extends Controller {
	...
	public function index() {
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output .= '// URL' . "\n";
			$output .= 'define(\'URL\', $_SERVER[\'HTTP_HOST\'] . dirname($_SERVER[\'PHP_SELF\']) . \'/\');'. "\n\n";

			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'http://\' . URL);' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'http://\' . URL);' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'BASE_DIR\', realpath(dirname(__FILE__)));' . "\n";
			$output .= 'define(\'DIR_APPLICATION\',  BASE_DIR . \'/catalog/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\',  BASE_DIR . \'/system/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\',  BASE_DIR . \'/catalog/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\',  BASE_DIR . \'/catalog/view/theme/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\',  BASE_DIR . \'/system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\',  BASE_DIR . \'/image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\',  BASE_DIR . \'/system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\',  BASE_DIR . \'/system/download/\');' . "\n";
			$output .= 'define(\'DIR_UPLOAD\',  BASE_DIR . \'/system/upload/\');' . "\n";
			$output .= 'define(\'DIR_MODIFICATION\',  BASE_DIR . \'/system/modification/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\',  BASE_DIR . \'/system/logs/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG_IMG\', \'catalog/view/theme/default/image/\');' . "\n\n";
			...
			$output .= '// URL' . "\n";
			$output .= 'define(\'URL\', $_SERVER[\'HTTP_HOST\'] . str_replace(\'/admin\', \'\', dirname($_SERVER[\'PHP_SELF\'])));'. "\n\n";

			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'http://\' . URL . \'/admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'http://\' . URL . \'/\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'http://\' . URL . \'/admin/\');' . "\n";
			$output .= 'define(\'HTTPS_CATALOG\', \'http://\' . URL . \'/\');' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'BASE_DIR\', str_replace(DIRECTORY_SEPARATOR . \'admin\', \'\', realpath(dirname(__FILE__))) . \'/\');' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', BASE_DIR . \'/admin/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', BASE_DIR . \'/system/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', BASE_DIR . \'/admin/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', BASE_DIR . \'/admin/view/template/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', BASE_DIR . \'/system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', BASE_DIR . \'/image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', BASE_DIR . \'/system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', BASE_DIR . \'/system/download/\');' . "\n";
			...
			$output .= 'define(\'DIR_LOGS\', BASE_DIR . \'/system/logs/\');' . "\n";
			$output .= 'define(\'DIR_MODIFICATION\', BASE_DIR . \'/system/modification/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG\', BASE_DIR . \'/catalog/\');' . "\n\n";
	...
	private function validate() {
		...
		if ($this->request->post['db_driver'] == 'mysqli') {
			...
			if ($mysql->connect_error) {
				...
				$sql = "CREATE DATABASE ".$this->request->post['db_database'];
