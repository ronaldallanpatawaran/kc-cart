      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="row" style="margin-left: 20px;">
            <div class="col-sm-12 login-credentials">Admin Login Credentials</div>
            ...
            <div class="col-sm-3">developer</div>
            <div class="col-sm-3">password</div>
            <div class="col-sm-4">&nbsp;</div>

            <div class="col-sm-2">Administrator</div>
            <div class="col-sm-3">firstcom</div>
            <div class="col-sm-3">password</div>
            <div class="col-sm-4">&nbsp;</div>

            <div class="col-sm-12 login-credentials">Customer Login Credentials</div>
            ...
            <div class="col-sm-3">test@test.com</div>
            <div class="col-sm-3">test</div>
            <div class="col-sm-4">&nbsp;</div>
          </div>
          <p style="clear:both; margin-top:35px; margin-left:20px;"><span style="color: red">***</span> Do note that developer account (full accessibility for the admin panel) is strictly for programmer use only.</p>
        </fieldset>
        <div class="buttons">
